    ...
    async function (req, res, next) {
      try {
        ...
        let addToCart = {
          ...
          orderListingId: NFT.currentOrderListingId,
        };
  ...
  .post(
    ...
    async function (req, res, next) {
      try {
        ...
        await OrderListingModel.updateMany(
          {
            _id: {
              $in: ids,
            },
  ...
  .delete(
    ...
    async function (req, res, next) {
      try {
        ...
        if (!NFTInCart.userId.equals(req.user._id)) {
          return res.status(400).json({
            success: false,
  ...
  .get(
    ...
    async function (req, res, next) {
      try {
        ...
        const NFTs = await CartModel.find({ userId: req.user._id });
